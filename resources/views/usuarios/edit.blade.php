<div class="row">
    <div class="col-4">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control form-control-sm" id="tel_movil" placeholder="Teléfono Móvil" value="{{ $usuario->DatosUsuarios->telefono_fijo }}">
        </div>
        <div class="form-group">
            <label for="tel_fijo">Teléfono Fijo :</label>
            <input type="text" class="form-control form-control-sm" id="tel_fijo" placeholder="Teléfono Fijo" value="{{ $usuario->DatosUsuarios->telefono_movil }}">
        </div>
        <div class="form-group">
            <label for="extension">Extensión :</label>
            <input type="text" class="form-control form-control-sm" id="extension" placeholder="Extensión" value="{{ $usuario->DatosUsuarios->extension }}">
        </div>
        <div class="form-group">
            ...
            <select name="empresa" id="empresa" class="form-control form-control-sm">
                ...
                @foreach( $empresas as $empresa )
                    <option value="{{ $empresa->id }}" {{ $usuario->Empresas->first()->id == $empresa->id ? 'selected="selected"' : '' }}>{{ $empresa->razon_social }}</option>
                @endforeach
            </select>
        </div>
        <div class="form-group">
